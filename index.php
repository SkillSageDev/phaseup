...
<html lang="en">
  <head>
    ...
    <script src="./scripts/courseGrid.js" defer></script>
  ...
  <body>
    ...
    <div id="intro">
      <div class="curtain">
        <div class="curtain__black"></div>
        <div class="curtain__gradient"></div>
      </div>
      <i class="intro__logo"></i>
      <p>PhaseUp</p>
    </div>
    ...
    <header>
      ...
      <div class="menu" id="menu">
        <ul>
          ...
          <li><a href="#" class="element">Data Science</a></li>
          <li><a href="#" class="element">Game</a></li>
          <li><a href="#" class="element">Web</a></li>
        </ul>
      </div>
    </header>
    ...
    <main>
      ...
      <div id="welcome">
        <div class="bg">
          <h1>Welcome to PhaseUp</h1>
          <h2>Your path to mastering all subjects</h2>
        </div>
      </div>
      <!-- Favorite line -->
      ...
      <!-- Trending -->
      <p class="lineTitle">Trending</p>
      <ul class="card-list"></ul>

      <!-- Newly Added -->
      <p class="lineTitle">Newly Added</p>
      <ul class="card-list"></ul>
    </main>
    ...
    <script src="./scripts/bg-animate.js"></script>
