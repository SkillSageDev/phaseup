...
<head>
    ...
    <link rel="stylesheet" href="./../styles/proceedPayment.css"/>
</head>
<body>
    <header>
        <div class="container">
          ...
          <div class="logo">
            <a href="#"><img src="./../assets/icons/figma-cons/PhaseUp Logo.svg" alt="logo"/></a>
          </div>
          <div class="explore">
    ...
    <main>
        <h1>Checkout</h1>
        <div id="productImage">
            <img src="./../assets/course banners/Csharp course 2.svg" alt="">
        </div>
