...
<head>
    ...
    <link rel="stylesheet" href="./../styles/courseOverview.css" />
    ...
    <section class="course-overview">
      <div class="lectures-overview">
        <img
          ...
          src="./../assets/course banners/تعلم HTML في فيديو واحد 1.svg"
          alt="course banner"
        />
      ...
      <div class="flex">
        <h1 id="course-label">LEARN HTML IN 4 HOURS</h1>
        ...
        <div class="course-length">
          <p id="students-count">12,037 students</p>
          <div class="course-length">
            <img
              id="clock-icon"
              ...
              alt=" watch image"
            />
            <p id="course-length">2hrs & 30min</p>
          </div>
        </div>
        <div class="course-description">
          <h1>description :</h1>
          <p>
            If You Wanted To Develop You're First App Then You're On Your Way.
            <br />
            hi, I Am Elzero & in this Course You Will Learn Everything About
            HTML From Scratch, This Course Will Let you Create Any HTML file in
            front Of You're Way.
          </p>
        </div>
      </div>
      ...
      <div class="enrol">
        <a id="enrol-button" href="./payment.php">Enroll Now</a>
        <!-- <a id="review-button" href="#">Reviews</a> -->
      </div>
    </section>
    </main>
